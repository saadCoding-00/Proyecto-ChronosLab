# PROMPTS.md – Proyecto ChronosLab (Single Page)

## Prompt 1 – Estructura base de página única

**Objetivo:** generar la estructura inicial de una aplicación Angular de una sola página.

**Prompt usado:**

Crea la estructura básica de una aplicación Angular tipo single page para una web corporativa llamada "ChronosLab" con las secciones: Inicio, Servicios, Informes y Contacto, usando componentes pero sin Angular Router.

**Para qué se usó:**
Para crear la estructura general de la aplicación en una sola página.

**Qué se revisó o modificó:**
- Se eliminaron rutas.
- Se integraron todos los componentes en AppComponent.
- Se añadió navegación por scroll.

## Prompt 2 – Sección Inicio
